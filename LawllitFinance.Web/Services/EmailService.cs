...
public class EmailService(IConfiguration config, ILogger<EmailService> logger, IStringLocalizerFactory localizerFactory) : IEmailService
{
    ...
    private static string BuildEmailBody(string heading, string greeting, string actionUrl, string actionLabel, string footerLine1, string footerLine2)
        => $"""
            <!DOCTYPE html>
            <html lang="pt-BR">
